...
const clearClass = "flex w-12 h-12 justify-center items-center m-1 font-bold py-2 border hover:border-transparent rounded text-white border-2 text-2xl hover:bg-red-500 border-red-500";
